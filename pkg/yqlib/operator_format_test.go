...
var formatOperatorScenarios = []expressionScenario{
	{
...
func TestFormatOperatorScenarios(t *testing.T) {
	for _, tt := range formatOperatorScenarios {
		testScenario(t, &tt)
	}
	documentOperatorScenarios(t, "format", formatOperatorScenarios)
}
