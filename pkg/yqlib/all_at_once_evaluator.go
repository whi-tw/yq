...
type Evaluator interface {
	...
	EvaluateNodes(expression string, nodes ...ast.Node) (*list.List, error)
...
func (e *allAtOnceEvaluator) EvaluateNodes(expression string, nodes ...ast.Node) (*list.List, error) {
